...
class CircuitBreaker:
    """Circuit breaker with a three-state provider protection policy.
    ...
    def allow_request(self) -> bool:
        ...
        # ``opened_at`` should always be populated when the breaker opens.  Be
        # conservative if a caller manually constructs an inconsistent OPEN
        # state: fail fast instead of accidentally flooding the provider.
