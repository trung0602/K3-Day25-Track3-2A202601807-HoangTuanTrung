...
class RunMetrics(BaseModel):
    ...
    def write_csv(self, path: str | Path) -> None:
        ...
        # Detailed nested evidence remains in JSON; the single-row CSV keeps
        # compact JSON strings for fields that cannot be represented as scalar
        # columns without losing their structure.
        for nested_field in ("scenario_details", "cache_comparison"):
            report[nested_field] = json.dumps(report[nested_field], ensure_ascii=False)
